...
public class SumValuesCombiner extends FDNoiseValueCombiner<SumValuesCombiner> {
    ...
    @Override
    public ObjectType<SumValuesCombiner> getType() {
        return NoiseValueCombinerRegistry.SUM;
    }
